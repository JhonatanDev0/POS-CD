...
#Podemos também querer a probabilidade de que até dois clientes comprem. Ao invés de saber a probabilidade de exatos dois comprarem.
...
va_geometrica
plot(va_geometrica) #Veja como as probabilidades vão diminuindo. A probabilidade de sucesso de 50% é relativamente alta, então é muito provavel que o sucesso ocorra logo nas primeiras tentativas
# Podemos utilizar a distribuição geométrica acumulada para saber qual a probabilidade do primeiro sucesso ocorrer na primeira tentativa OU na segunda tentativa OU na terceira tentativa
...
# Observe que os valores se distribuiem simetricamente en tormo de seis, use acontece porque o parametro lambda é a média (e também o desvio padrão) da distribuição de Poisson
