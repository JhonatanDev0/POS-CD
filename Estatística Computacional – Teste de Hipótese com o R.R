...
dados <- data.frame(
  ...
  Cliente = c("Adulto_com_Crianca", "Adulto_com_Crianca", "Adulto_com_Crianca",
              ...
              "Adulto_com_Crianca", "Adulto", "Adulto", "Adulto", "Adulto","Adulto_com_Crianca", "Adulto_com_Crianca", "Adulto_com_Crianca",
  ...
  Comprou = c("Não_Comprou", "Não_Comprou", "Não_Comprou", "Não_Comprou",
              ...
              "Comprou", "Comprou", "Comprou", "Comprou", "Comprou", "Comprou","Comprou", "Comprou", "Comprou", "Comprou", "Comprou", "Comprou",
...
dados_anova <- data.frame(Gastos = c(174.770021661909, 161.329206619394,
                    ...
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados", "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
                    "Casados", "Casados", "Casados", "Casados", "Casados", "Casados",
